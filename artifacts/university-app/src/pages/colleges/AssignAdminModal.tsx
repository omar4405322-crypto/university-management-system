...
const AssignAdminModal: React.FC<AssignAdminModalProps> = ({ isOpen, onClose, collegeId, collegeName, onSuccess }) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const availableAdmins = (result.data || []).filter(
          (admin: any) => !admin.managedCollegeId || admin.managedCollegeId === collegeId
        );
