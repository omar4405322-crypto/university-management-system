        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {displayColleges.map((college) => (
            <Card
              key={college.id}
              noPadding
              className="group border border-brand-border/60 bg-brand-bg-card rounded-2xl overflow-hidden hover:shadow-[0_8px_30px_rgba(132,189,58,0.18)] hover:-translate-y-1.5 hover:border-brand-primary-500/50 transition-all duration-300"
            >
