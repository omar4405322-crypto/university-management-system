        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-brand-text-main flex items-center gap-2 ml-1">
              <User size={14} className="text-brand-text-muted" /> {t('doctors.firstName')}{' '}
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-brand-text-main flex items-center gap-2 ml-1">
              <User size={14} className="text-brand-text-muted" /> {t('doctors.lastName')}{' '}
              <span className="text-rose-500">*</span>
            </label>
            <Input
              name="lastName"
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-brand-text-main flex items-center gap-2 ml-1">
              <Hash size={14} className="text-brand-text-muted" /> {t('doctors.doctorId')}{' '}
              <span className="text-rose-500">*</span>
            </label>
            <Input
              name="doctorId"
