  ...
  return (
    <div className="section-gap animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3 p-4 bg-brand-navy-500 text-white rounded-2xl shadow-xl">
          ...
          <div className="overflow-x-auto">
            <div className="min-w-[1000px]">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-brand-navy-500/5 border-b border-brand-border">
                ...
                <tbody className="divide-y divide-brand-border">
                  {times.map((time) => (
                    <tr key={time} className="group">
                      <td className="p-4 text-[10px] font-black text-brand-text-muted text-center bg-brand-navy-500/[0.02] border-r border-brand-border">
                        {formatTime(time)}
                      </td>
                      {days.map((day) => {
                        ...
                        return (
                          <td
                            key={`${day}-${time}`}
                            className="p-2 border-r border-brand-border last:border-r-0 align-top group-hover:bg-brand-navy-500/[0.01] transition-colors"
                          >
                            {entries.length > 0 ? (
                                  ...
                                  >
                                    ...
                                    <div className="mt-3 space-y-2">
                                      <div className="flex items-center gap-2 text-[10px] font-bold text-brand-text-sub">
                                        <div className="p-1 bg-brand-navy-500/5 rounded-md">
                                          <MapPin size={10} />
                                        </div>
              ...
              >
                ...
                <div className="pt-4 border-t border-brand-border flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 rounded-full bg-brand-navy-500/5 flex items-center justify-center">
                      <User size={14} className="text-brand-navy-500" />
                    </div>
