...
import { UNIVERSITY_LOGO, getCampusFallbackImage } from '../constants/universityAssets';
  ...
  return (
    <div
      className={`absolute inset-0 ${
        useLogoFallback ? 'flex items-center justify-center bg-gray-50 dark:bg-slate-800' : ''
      }`}
    >
      <img
        src={src}
