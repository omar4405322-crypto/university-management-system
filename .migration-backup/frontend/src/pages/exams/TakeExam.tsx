              ...
              <Card title="Pre-Exam Checklist" borderLeft={false}>
                <div className="space-y-4 pt-2">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-3 p-3 rounded-xl hover:bg-brand-navy-500/5 transition-colors group"
                    >
      ...
      {status === 'IN_PROGRESS' && (
        <div className="space-y-8">
          <div className="sticky top-4 z-20 flex justify-between items-center bg-brand-bg-card/80 backdrop-blur-xl p-4 rounded-[2rem] border border-brand-border shadow-soft">
            ...
            <div
              className={`flex items-center px-6 py-2.5 rounded-2xl font-mono text-lg font-black shadow-inner transition-colors ${false ? 'bg-error text-white animate-pulse' : 'bg-brand-navy-500 text-brand-green'}`}
            >
