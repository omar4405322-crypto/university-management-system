...
const DepartmentsList = () => {
  ...
  return (
    <div className="section-gap animate-page">
          ...
          {filteredDepartments.map((dept) => {
            ...
            <Card
              ...
              className={`group border-none shadow-soft hover:-translate-y-2 duration-500 overflow-hidden flex flex-col ${
                isSelected ? 'ring-2 ring-brand-primary-500 bg-brand-primary-500/5' : ''
            ...
            >
              <div className={`flex-grow relative ${isCompact ? 'p-5' : 'p-8'}`}>
                ...
                <div className={`flex justify-between items-start ${isCompact ? 'mb-4' : 'mb-6'}`}>
                  <div className={`${isCompact ? 'w-10 h-10 ml-6' : 'w-14 h-14 ml-8'} rtl:mr-8 rtl:ml-0 bg-brand-primary-50 dark:bg-brand-primary-900/10 rounded-2xl flex items-center justify-center text-brand-primary-500 group-hover:scale-110 group-hover:bg-brand-primary-500 group-hover:text-white transition-all duration-500 shadow-inner`}>
                ...
                <div className="space-y-1">
                  ...
                  <h3 className={`${isCompact ? 'text-xl' : 'text-2xl'} font-black text-brand-text-primary dark:text-brand-text-main tracking-tight group-hover:text-brand-primary-500 transition-colors duration-300`}>
                ...
                <div className={`grid grid-cols-2 gap-4 ${isCompact ? 'mt-4 pt-4' : 'mt-8 pt-8'} border-t border-brand-border dark:border-brand-border`}>
                  ...
                  <div className={`${isCompact ? 'p-2' : 'p-4'} bg-surface-subtle dark:bg-slate-800/50 rounded-2xl text-center group-hover:bg-brand-primary-500 group-hover:text-white transition-colors duration-500`}>
      ...
      >
        {activeDrawerId && (
          <Suspense fallback={<div className="flex justify-center p-12"><Loader2 className="animate-spin text-brand-primary-500" size={32} /></div>}>
