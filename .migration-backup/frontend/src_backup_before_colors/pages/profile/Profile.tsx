              ...
              {fullProfile && (
                <div className="mt-3 space-y-0.5">
                  {(fullProfile.studentId || fullProfile.doctorId) && (
                    <p className="text-xs font-bold text-brand-primary-500">
                      {fullProfile.studentId || fullProfile.doctorId}
                    </p>
                  )}
          ...
          <Card>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-black text-brand-primary-500">
                  {user?.profileCompletion || 85}%
                </span>
              </div>
              <div className="h-2 w-full rounded-full bg-brand-bg-page overflow-hidden">
                <div
                  className="h-full rounded-full bg-gradient-to-r from-brand-primary-400 to-brand-primary-500 shadow-sm"
