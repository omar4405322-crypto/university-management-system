...
const LandingPage = () => {
  ...
  return (
    <div
      className="min-h-screen bg-white font-arabic selection:bg-brand-green/30 selection:text-brand-navy overflow-x-hidden"
      dir="rtl"
    >
      {/* 1. Navbar */}
      <nav
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 relative z-10 min-w-0 flex-shrink-0">
            ...
            <button className={`video-btn hidden md:flex items-center gap-2 ${isScrolled ? 'text-brand-navy' : 'text-white'}`} aria-label="Watch Introduction Video">
              <span className="label hidden md:inline text-sm font-bold px-2 py-1 rounded bg-white/90 text-brand-navy">
                جولة افتراضية
              </span>
          ...
          <button
            ...
            className={`lg:hidden p-2 z-[101] relative rounded-xl transition-colors ${
              isScrolled
                ? 'text-brand-navy hover:bg-brand-primary-50'
        ...
        {/* Mobile Menu Overlay */}
        <div
          className={`fixed inset-0 z-[99] bg-brand-navy/98 backdrop-blur-md transition-all duration-500 lg:hidden ${
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center h-full gap-6 px-8 pt-16">
            ...
            <Link
              to="/login"
              onClick={() => setIsMobileMenuOpen(false)}
              className="mt-4 w-full max-w-xs py-4 rounded-2xl bg-brand-green text-brand-navy font-black text-lg shadow-xl text-center"
            >
              تسجيل الدخول
            </Link>
          ...
          <div className="container mx-auto px-6">
            <div className="stats-cards-row grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-white/95 backdrop-blur-md p-8 md:p-10 rounded-[2rem] shadow-2xl shadow-brand-navy/10 border border-brand-border flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-500 ring-1 ring-brand-navy/5 min-h-[140px]"
                >
                  ...
                  {statsLoading || !stat.value ? (
                    ...
                    <h4 className="text-2xl md:text-3xl font-black text-brand-navy mb-1">
                      {stat.value}
                    </h4>
                  )}
      ...
      {/* 3. About Section */}
      <section id="about" className="pt-52 pb-24 lg:pt-60 lg:pb-32 bg-brand-bg-page relative overflow-hidden">
        <div className="container mx-auto px-6">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div className="flex flex-wrap gap-3">
                {['معتمدة دولياً', 'بحث علمي متقدم', 'شراكات عالمية'].map((pill) => (
                  <span
                    key={pill}
                    className="px-5 py-2 rounded-xl bg-white border border-brand-border text-brand-navy text-xs font-black shadow-soft hover:shadow-md hover:border-brand-green transition-all duration-300"
                  >
                    {pill}
                  </span>
                ))}
        ...
        <div className="container mx-auto px-6">
          <div className="relative rounded-[3rem] overflow-hidden bg-gradient-to-r from-brand-green to-brand-green-dark p-12 md:p-20 text-center space-y-8 shadow-2xl shadow-brand-green/30">
            ...
            <div className="relative z-10 space-y-6">
              <h2 className="text-4xl md:text-6xl font-black text-brand-navy tracking-tight">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                <a
                  href="#"
                  aria-label="Facebook"
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:bg-brand-green hover:text-brand-navy hover:border-brand-green transition-all duration-300 text-sm font-bold"
                >
                  f
                </a>
                <a
      ...
      <style
        ...
        /* 7. Login Button */
        .login-btn {
          background: var(--color-brand-navy, #1a2744);
          color: #ffffff;
          border: none;
          border-radius: 8px;
          padding: 10px 20px;
