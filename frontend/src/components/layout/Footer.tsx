...
const Footer = () => {
  ...
  return (
    <footer className="shrink-0 bg-brand-navy-500 text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 py-12 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                {language === 'ar' && (
                  <span className="text-sm font-medium text-white/60 font-arabic">
                    {t('footer.universityNameAr')}
                  </span>
                )}
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-brand-green-dark/30 pb-2 inline-block w-fit">
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              {quickLinks.map(({ key, to }) => (
                <li key={key}>
                  <Link
                    to={to}
                    className="hover:text-brand-green-dark transition-colors underline decoration-white/10 hover:decoration-brand-green-dark"
                  >
                    {t(`footer.${key}`)}
                  </Link>
                </li>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold border-b border-brand-green-dark/30 pb-2 inline-block">
              {t('footer.contactUs')}
            </h3>
            <ul className="space-y-4 text-sm text-slate-400">
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-brand-green-dark shrink-0 mt-0.5" />
                <span>{t('footer.address')}</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} className="text-brand-green-dark shrink-0" />
                <a
              ...
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-brand-green-dark shrink-0" />
                <a
                ...
                <>
                  <div className="flex gap-2">
                    <input
                      ...
                      className="bg-slate-800/50 border border-white/10 rounded-lg px-3 py-2 text-sm w-full focus:outline-none focus:ring-2 focus:ring-brand-green-dark text-white placeholder:text-slate-500"
                    />
                    <button
                      type="submit"
                      className="bg-brand-green-dark text-white px-4 py-2 rounded-lg hover:bg-brand-primary-600 transition-colors text-xs font-black uppercase tracking-widest"
                    >
                      {t('footer.subscribe')}
                    </button>
                  </div>
