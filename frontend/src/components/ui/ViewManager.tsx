  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm font-bold bg-surface-subtle dark:bg-slate-800 rounded-xl hover:bg-brand-primary-50 dark:hover:bg-brand-primary-900/20 text-brand-text-secondary hover:text-brand-green-dark transition-colors"
      >
              ...
              {views.map((view) => (
                <div
                  ...
                  className={`flex items-center justify-between px-3 py-2 hover:bg-surface-subtle dark:hover:bg-slate-700/50 cursor-pointer group ${
                    view.id === activeViewId ? 'text-brand-green-dark bg-brand-primary-50/50 dark:bg-brand-primary-900/10' : 'text-brand-text-secondary'
                  }`}
                  onClick={() => {
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    {!view.isDefault && (
                      <button
                        ...
                        className="p-1 text-brand-text-muted hover:text-brand-green-dark"
            ...
            <div className="p-3 bg-surface-subtle dark:bg-slate-900/50 border-t border-brand-border dark:border-brand-border space-y-2">
              {isCreating ? (
                ...
                <div className="flex flex-col gap-1">
                  <button
                    className="flex items-center gap-2 px-2 py-1.5 text-xs font-bold text-brand-text-secondary hover:text-brand-green-dark rounded-lg hover:bg-brand-primary-50 dark:hover:bg-brand-primary-900/20 transition-colors w-full"
