      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <Card className="overflow-hidden">
            <div className="relative px-6 pt-8 pb-6 text-center">
              <div className="relative mx-auto h-28 w-28">
                <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-brand-green to-brand-primary-600 text-4xl font-black text-white ring-4 ring-brand-primary-100 shadow-xl overflow-hidden">
                  {user?.profilePicture ? (
                    <img
                ...
                <button
                  ...
                  className="absolute bottom-1 right-1 rounded-full bg-brand-bg-card dark:bg-slate-700 p-1.5 shadow-lg border border-brand-border text-brand-text-sub hover:text-brand-green-dark transition-colors"
          ...
          <Card>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-black text-brand-green-dark">
                  {user?.profileCompletion || 85}%
                </span>
              </div>
              <div className="h-2 w-full rounded-full bg-brand-bg-page overflow-hidden">
                <div
                  className="h-full rounded-full bg-gradient-to-r from-brand-green to-brand-green-dark shadow-sm"
            ...
            <Card>
              <div className="space-y-4">
                <p className="text-xs font-black text-brand-text-muted uppercase tracking-widest flex items-center gap-2">
                  <Building2 size={14} className="text-brand-green-dark" /> {t('profile.college')}
                </p>
        ...
        <div className="lg:col-span-3 space-y-6">
            ...
            <Card>
              <div className="px-6 py-5 border-b border-brand-border">
                <h2 className="text-lg font-black text-brand-text-primary tracking-tight m-0 flex items-center gap-2">
                  <Award size={20} className="text-brand-green-dark" /> {t('profile.academicInfo')}
                </h2>
                <p className="text-xs font-semibold text-brand-text-muted mt-0.5">
          ...
          <Card>
            <div className="px-6 py-5 border-b border-brand-border">
              <h2 className="text-lg font-black text-brand-text-primary tracking-tight m-0 flex items-center gap-2">
                <Shield size={20} className="text-brand-green-dark" /> {t('profile.security')}
              </h2>
              <p className="text-xs font-semibold text-brand-text-muted mt-0.5">
        ...
        <div className="space-y-4">
          <div className="flex flex-col items-center justify-center border-2 border-dashed border-brand-border rounded-2xl p-8 bg-brand-bg-page/30 transition-all hover:bg-brand-bg-page/50">
            {previewUrl ? (
              ...
              <>
                <div className="h-20 w-20 rounded-full bg-brand-primary-50 flex items-center justify-center text-brand-green-dark mb-4">
                  <Camera size={40} />
                </div>
                ...
                <label className="cursor-pointer">
                  <span className="bg-brand-green-dark text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-brand-primary-600 transition-all inline-block shadow-lg shadow-brand-green-dark/20">
