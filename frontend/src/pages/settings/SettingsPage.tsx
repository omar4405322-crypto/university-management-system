            ...
            <Card>
              ...
              <div className="p-6 bg-gradient-to-r from-brand-primary-50/50 to-transparent border-b border-brand-border">
                <div className="flex items-center gap-5">
                  <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-brand-green to-brand-primary-600 flex items-center justify-center text-white text-xl font-black shadow-lg shrink-0">
                    {user?.firstName?.[0]}
                    {user?.lastName?.[0]}
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 bg-brand-bg-card dark:bg-brand-bg-elevated border rounded-xl text-sm font-bold text-brand-text-primary placeholder:text-brand-text-muted focus:outline-none focus:ring-2 focus:ring-brand-green-dark/20 transition-all ${errors.firstName ? 'border-error focus:ring-error/20' : 'border-brand-border'}`}
            ...
            <Card>
              ...
              <div className="p-6 space-y-6">
                <div className="flex items-center justify-between p-4 rounded-xl border border-brand-border bg-brand-bg-page/30">
                  ...
                  <button
                    onClick={toggleTheme}
                    className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-brand-green-dark/30 shrink-0 ${isDark ? 'bg-brand-green-dark' : 'bg-slate-200'}`}
                  >
                    <span
