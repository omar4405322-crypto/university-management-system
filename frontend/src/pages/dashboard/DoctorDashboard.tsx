      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 gap-5 xl:gap-6 2xl:gap-8">
            ...
            <div className="p-5 space-y-3">
              <div className="flex justify-between items-start">
                <div className={`p-2.5 rounded-2xl transition-colors duration-300 ${
                  kpi.color === 'green' ? 'bg-brand-primary-50 text-brand-green-dark group-hover:bg-[var(--kpi-icon-hover)] group-hover:text-white'
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm font-medium text-gray-600">Exam Sessions</span>
          </div>
          <div className="flex gap-4">
            <div>
              <p className="text-2xl font-bold text-gray-900">{stats?.activeExamSessions ?? 0}</p>
              <p className="text-xs text-gray-400">Active Now</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-orange-500">{stats?.pendingGrading ?? 0}</p>
              <p className="text-xs text-gray-400">Pending Grade</p>
            </div>
          </div>
        </div>
      </div>
