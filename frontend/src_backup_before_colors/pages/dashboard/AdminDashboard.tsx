              ...
              <div className="flex justify-between items-start">
                <div
                  className={`p-2.5 rounded-2xl transition-colors duration-300 ${
                    kpi.color === 'green'
                      ? 'bg-brand-primary-50 text-brand-primary-500 group-hover:bg-[var(--kpi-icon-hover)] group-hover:text-white'
                      : kpi.color === 'navy'
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="p-6 rounded-2xl bg-surface-subtle border border-brand-border space-y-5">
                ...
                <div className="h-2 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                  <div className="h-full bg-brand-primary-500 rounded-full shadow-lg transition-all duration-500" style={{ width: `${subscriptionUsagePercent}%` }} />
                </div>
