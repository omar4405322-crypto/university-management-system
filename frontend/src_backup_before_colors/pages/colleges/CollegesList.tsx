            ...
            >
              <div className="relative h-64 w-full overflow-hidden">
                ...
                <div className="absolute bottom-6 right-6 left-6 z-20">
                  <Badge
                    variant="success"
                    className="mb-3 px-3 py-1 text-[10px] font-black tracking-widest uppercase bg-brand-primary-500/90 text-white border-none shadow-lg"
                  >
                    {t('colleges.active')}
                  </Badge>
                ...
                <div className="mt-8 grid grid-cols-2 gap-6 border-t border-brand-border dark:border-brand-border pt-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-[10px] font-black text-brand-primary-500 uppercase tracking-widest">
