...
const Badge: React.FC<BadgeProps> = ({ children, variant = 'info', className = '' }) => {
  const variants = {
    ...
    primary:
      'bg-brand-primary-50 text-brand-primary-700 border-brand-primary-100 dark:bg-brand-primary-500/10 dark:text-brand-primary-400 dark:border-brand-primary-500/20',
  };
