    ...
    <footer className="shrink-0 bg-brand-navy text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 py-12 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold border-b border-brand-primary-500/30 pb-2 inline-block">
              {t('footer.contactUs')}
            </h3>
              ...
              {subscribed ? (
                ...
                <>
                  <div className="flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="bg-brand-primary-500 text-white px-4 py-2 rounded-lg hover:bg-brand-primary-600 transition-colors text-xs font-black uppercase tracking-widest"
                    >
                      {t('footer.subscribe')}
                    </button>
                  </div>
